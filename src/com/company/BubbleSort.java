...
public class BubbleSort {
    ...
    public void sort() {
        ...
        for (int i=0; i<n; i++) { // Outer loop loops through each element of the array
            for (int j=1; j<n; j++) { // Inner loop loops through the array again for EACH of the elements in the array
